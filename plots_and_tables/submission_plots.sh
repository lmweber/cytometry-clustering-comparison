...
# convert to EPS
pdftops -eps -paperw 2100 ../../plots_submission/Fig1_Levine_32dim.pdf ../../plots_submission/Fig1_Levine_32dim.eps


# Figure 2: Cluster medians (Levine_32dim, FlowSOM)

# rename and move PDF file
cp ../../plots/Levine_32dim/cluster_medians/cluster_medians_heatmap_FlowSOM_Levine32dim.pdf ../../plots_submission/Fig2_cluster_medians.pdf
# convert to EPS
pdftops -eps -paperw 1400 ../../plots_submission/Fig2_cluster_medians.pdf ../../plots_submission/Fig2_cluster_medians.eps
...
# convert to EPS
pdftops -eps -paperw 970 ../../plots_submission/Fig3_Mosmann_rare.pdf ../../plots_submission/Fig3_Mosmann_rare.eps
