#########################################################################################
# Function to run immunoClust for stability analysis
# 
# This script contains a function to run immunoClust once for each data set for the
...
run_immunoClust_stability <- function(data_list) {
  ...
  res_stability_immunoClust_Levine_32 <- c(
  ...
  res_stability_immunoClust_Levine_13 <- c(
  ...
  res_stability_immunoClust_Nilsson <- c(
  ...
  res_stability_immunoClust_Mosmann <- c(
  ...
  list(res_stability_immunoClust_Levine_32, 
       res_stability_immunoClust_Levine_13, 
       res_stability_immunoClust_Nilsson, 
       res_stability_immunoClust_Mosmann)
}
