#########################################################################################
# R script to run FlowSOM for stability analysis
# 
# This script runs one iteration of FlowSOM for the stability analysis. The main script 
...
res_stability_FlowSOM_Levine_32 <- list(
...
res_stability_FlowSOM_Levine_13 <- list(
...
res_stability_FlowSOM_Nilsson <- list(
...
res_stability_FlowSOM_Mosmann <- list(
