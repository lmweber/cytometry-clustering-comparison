#########################################################################################
# R script to run SamSPECTRAL for robustness analysis
# 
# This script runs one iteration of SamSPECTRAL for the robustness analysis. The main 
...
res_robust_SamSPECTRAL_Levine_32 <- list(
...
res_robust_SamSPECTRAL_Levine_13 <- list(
...
res_robust_SamSPECTRAL_Nilsson <- list(
...
res_robust_SamSPECTRAL_Mosmann <- list(
