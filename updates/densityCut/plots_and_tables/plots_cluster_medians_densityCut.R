...
# detected clusters and manually gated populations; including densityCut)
#
...
load("main_results_densityCut.RData")
...
clus_methods <- list(
  ...
  densityCut = clus_densityCut,  ## including densityCut
  DensVM = clus_DensVM, 
  FLOCK = clus_FLOCK, 
...
clus_truth <- list(
  ...
  densityCut = clus_truth_densityCut,  ## including densityCut
...
filename_truth <- paste0("../../../../../clustering_comparison_updates/densityCut/plots/", 
                         "Levine_32dim/cluster_medians/cluster_medians_heatmap_truth_Levine_32dim.pdf")
...
plot_heights_Levine_32dim <- c(9, 7.5, 5.75, 6, 8.5, 10, 4.5, 10, 14, 14, 10, 8.75, 10, 5.75, 14, 10)  ## including densityCut
fontsize_row_Levine_32dim <- c(8, 8,   8,    8, 8,   8,  8,   8,  6,  6,  8,  8,    8,  8,    1,  8)  ## including densityCut
...
for (i in 1:length(medians_Levine_32dim)) {
  ...
  filename <- paste0("../../../../../clustering_comparison_updates/densityCut/plots/", 
                     "Levine_32dim/cluster_medians/cluster_medians_heatmap_", 
