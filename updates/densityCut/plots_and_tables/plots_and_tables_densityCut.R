#########################################################################################
# R script to generate plots and tables of main results (including densityCut)
#
...
source("evaluate_all_methods_densityCut.R")  ## runtime: 20 min
source("evaluate_runtime_densityCut.R")
setwd(CURRENT_DIR)
...
res_all <- list(
  ...
  densityCut = res_densityCut,  ## including densityCut
  DensVM = res_DensVM, 
  FLOCK = res_FLOCK, 
...
sink("../../../../../clustering_comparison_updates/densityCut/tables/table_main_results.txt")
...
# export table in Latex format
sink("../../../../../clustering_comparison_updates/densityCut/tables/table_FlowCAP_results.txt")
...
for (i in 1:4) {
  ...
  filename <- paste0("../../../../../clustering_comparison_updates/densityCut/plots/", 
                     nm, "/main_plots/results_barplot_mean_F1_", nm, ".pdf")
...
for (i in 1:4) {
  ...
  filename <- paste0("../../../../../clustering_comparison_updates/densityCut/plots/", 
                     nm, "/main_plots/results_boxplots_F1_", nm, ".pdf")
...
for (i in 1:4) {
  ...
  filename <- paste0("../../../../../clustering_comparison_updates/densityCut/plots/", 
                     nm, "/main_plots/results_barplot_mean_F1_pr_re_", nm, ".pdf")
...
for (i in 1:4) {
  ...
  filename <- paste0("../../../../../clustering_comparison_updates/densityCut/plots/", 
                     nm, "/main_plots/results_no_of_cells_", nm, ".pdf")
...
for (i in 1:2) {
  ...
  filename <- paste0("../../../../../clustering_comparison_updates/densityCut/plots/", 
                     nm, "/main_plots/results_barplot_F1_pr_re_", nm, ".pdf")
...
for (i in 1:4) {
  ...
  filename <- paste0("../../../../../clustering_comparison_updates/densityCut/plots/", 
                     nm, "/main_plots/runtime_barplot_", nm, ".pdf")
...
for (i in 1:4) {
  ...
  filename <- paste0("../../../../../clustering_comparison_updates/densityCut/plots/", 
                     nm, "/main_plots/runtime_scatterplot_", nm, ".pdf")
...
for (i in 1:4) {
  ...
  filename <- paste0("../../../../../clustering_comparison_updates/densityCut/plots/", 
                     nm, "/main_plots/plots_multi_panel_", nm, ".pdf")
...
sink(file = "session_info_main_results_densityCut.txt")
print(sessionInfo())
sink()

save.image("main_results_densityCut.RData")
