#########################################################################################
# R script to load and evaluate results for immunoClust
#
...
RES_DIR_IMMUNOCLUST <- "../../results/auto/immunoClust"
...
files_truth_immunoClust <- files_truth
clus_truth_immunoClust <- clus_truth
...
files_out <- list(
  Levine_32dim = file.path(RES_DIR_IMMUNOCLUST, "immunoClust_labels_Levine_32dim.txt"), 
  Levine_13dim = file.path(RES_DIR_IMMUNOCLUST, "immunoClust_labels_Levine_13dim.txt"), 
  Samusik_01   = file.path(RES_DIR_IMMUNOCLUST, "immunoClust_labels_Samusik_01.txt"), 
  Samusik_all  = file.path(RES_DIR_IMMUNOCLUST, "immunoClust_labels_Samusik_all.txt"), 
  Nilsson_rare = file.path(RES_DIR_IMMUNOCLUST, "immunoClust_labels_Nilsson_rare.txt"), 
  Mosmann_rare = file.path(RES_DIR_IMMUNOCLUST, "immunoClust_labels_Mosmann_rare.txt"), 
  FlowCAP_ND   = file.path(RES_DIR_IMMUNOCLUST, "immunoClust_labels_FlowCAP_ND.txt"), 
  FlowCAP_WNV  = file.path(RES_DIR_IMMUNOCLUST, "immunoClust_labels_FlowCAP_WNV.txt")
)
...
files_immunoClust <- files_out
clus_immunoClust <- clus
