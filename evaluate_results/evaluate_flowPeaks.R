#########################################################################################
# R script to load and evaluate results for flowPeaks
#
...
RES_DIR_FLOWPEAKS <- "../../results/manual/flowPeaks"
...
files_truth_flowPeaks <- files_truth
clus_truth_flowPeaks <- clus_truth




##############################
### load flowPeaks results ###
##############################

# load cluster labels

files_out <- list(
  Levine_32dim = file.path(RES_DIR_FLOWPEAKS, "flowPeaks_labels_Levine_32dim.txt"), 
  Levine_13dim = file.path(RES_DIR_FLOWPEAKS, "flowPeaks_labels_Levine_13dim.txt"), 
  Samusik_01   = file.path(RES_DIR_FLOWPEAKS, "flowPeaks_labels_Samusik_01.txt"), 
  Samusik_all  = file.path(RES_DIR_FLOWPEAKS, "flowPeaks_labels_Samusik_all.txt"), 
  Nilsson_rare = file.path(RES_DIR_FLOWPEAKS, "flowPeaks_labels_Nilsson_rare.txt"), 
  Mosmann_rare = file.path(RES_DIR_FLOWPEAKS, "flowPeaks_labels_Mosmann_rare.txt"), 
  FlowCAP_ND   = file.path(RES_DIR_FLOWPEAKS, "flowPeaks_labels_FlowCAP_ND.txt"), 
  FlowCAP_WNV  = file.path(RES_DIR_FLOWPEAKS, "flowPeaks_labels_FlowCAP_WNV.txt")
)
