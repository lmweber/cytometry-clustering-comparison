#########################################################################################
# R script to load and evaluate results for k-means
#
...
RES_DIR_KMEANS <- "../../results/manual/kmeans"
...
files_out <- list(
  Levine_32dim = file.path(RES_DIR_KMEANS, "kmeans_labels_Levine_32dim.txt"), 
  Levine_13dim = file.path(RES_DIR_KMEANS, "kmeans_labels_Levine_13dim.txt"), 
  Samusik_01   = file.path(RES_DIR_KMEANS, "kmeans_labels_Samusik_01.txt"), 
  Samusik_all  = file.path(RES_DIR_KMEANS, "kmeans_labels_Samusik_all.txt"), 
  Nilsson_rare = file.path(RES_DIR_KMEANS, "kmeans_labels_Nilsson_rare.txt"), 
  Mosmann_rare = file.path(RES_DIR_KMEANS, "kmeans_labels_Mosmann_rare.txt"), 
  FlowCAP_ND   = file.path(RES_DIR_KMEANS, "kmeans_labels_FlowCAP_ND.txt"), 
  FlowCAP_WNV  = file.path(RES_DIR_KMEANS, "kmeans_labels_FlowCAP_WNV.txt")
)
