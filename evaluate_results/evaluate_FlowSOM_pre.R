...
RES_DIR_FLOWSOM_PRE <- "../../results/manual/FlowSOM_pre"
...
files_truth_FlowSOM_pre <- files_truth
clus_truth_FlowSOM_pre <- clus_truth
...
files_FlowSOM_pre <- files_out
clus_FlowSOM_pre <- clus
