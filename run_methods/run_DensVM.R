...
ix_subsample <- c(1, 2, 4, 6, 7, 8)
n_sub <- c(100000, 100000, NA, 100000, NA, 100000, 10000, 10000)
...
# save cluster labels
files_labels <- paste0("../../results/auto/DensVM/DensVM_labels_", 
                       names(clus), ".txt")
...
write.table(runtimes, file = "../../results/auto/runtimes/runtime_DensVM.txt", 
            quote = FALSE, sep = "\t")

# save session information
sink(file = "../../results/auto/session_info/session_info_DensVM.txt")
print(sessionInfo())
sink()
